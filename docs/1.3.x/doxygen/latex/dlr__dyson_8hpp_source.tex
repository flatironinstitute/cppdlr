...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#include\ <nda/linalg/eigh.hpp>}}
...
\DoxyCodeLine{00124\ \ \ \ \ \ \ nda::lapack::getrs(sysmat,\ transpose(g\_rs),\ ipiv);\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Back\ solve}}
...
\DoxyCodeLine{00184\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ [eval,\ evec]\ =\ nda::linalg::eigh(h);}
\DoxyCodeLine{00185\ }
