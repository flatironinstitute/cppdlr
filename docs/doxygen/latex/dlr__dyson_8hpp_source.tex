\hypertarget{dlr__dyson_8hpp_source}{}\doxysection{dlr\+\_\+dyson.\+hpp}
\label{dlr__dyson_8hpp_source}\index{/mnt/home/jkaye/Documents/projects/cppdlr/c++/cppdlr/dlr\_dyson.hpp@{/mnt/home/jkaye/Documents/projects/cppdlr/c++/cppdlr/dlr\_dyson.hpp}}
...
\DoxyCodeLine{00035\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ht,\ nda::Scalar\ Sh\ =\ std::conditional\_t<std::\textcolor{keywordtype}{float}ing\_po\textcolor{keywordtype}{int}<Ht>,\ Ht,\ get\_value\_t<Ht>>>}
...
\DoxyCodeLine{00061\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ g0\ \ =\ \mbox{\hyperlink{namespacecppdlr_af52a76483a86cc380b2bfb324a6fdbcb}{free\_gf}}(beta,\ itops,\ h,\ mu);\ \textcolor{comment}{//\ Free\ Green's\ function\ (right\ hand\ side\ of\ Dyson\ equation}}
...
\DoxyCodeLine{00065\ \ \ \ \ \ \ g0mat\ =\ itops\_ptr-\/>convmat(beta,\ \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435ac01c1699bb87ec8268ee33f7f20d84ee}{Fermion}},\ g0c,\ time\_order);}
\DoxyCodeLine{00066\ }
...
\DoxyCodeLine{00114\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ sysmat\ =\ make\_regular(nda::eye<double>(r\ *\ norb)\ -\/\ g0mat\ *\ itops\_ptr-\/>convmat(beta,\ \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435ac01c1699bb87ec8268ee33f7f20d84ee}{Fermion}},\ sigc,\ time\_order));}
\DoxyCodeLine{00115\ }
...
\DoxyCodeLine{00123\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ g\_rs\ =\ nda::matrix\_view<get\_value\_t<Tg>>(nda::reshape(g,\ norb,\ r\ *\ norb));\ \textcolor{comment}{//\ Reshape\ g\ to\ be\ compatible\ w/\ LAPACK}}
...
\DoxyCodeLine{00141\ \ \ \};}
\DoxyCodeLine{00142\ }
\DoxyCodeLine{00160\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Ht>}
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keyword}{requires}(std::floating\_point<Ht>\ ||\ nda::MemoryMatrix<Ht>)}
\DoxyCodeLine{00162\ \ \ \textcolor{comment}{//\ If\ h\ is\ scalar,\ return\ scalar-\/valued\ Green's\ function;\ if\ h\ is\ matrix,}}
\DoxyCodeLine{00163\ \ \ \textcolor{comment}{//\ return\ matrix-\/valued\ Green's\ function}}
\DoxyCodeLine{00164\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{namespacecppdlr_af52a76483a86cc380b2bfb324a6fdbcb}{free\_gf}}(\textcolor{keywordtype}{double}\ beta,\ \mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\_ops}}\ \textcolor{keyword}{const}\ \&itops,\ Ht\ \textcolor{keyword}{const}\ \&h,\ \textcolor{keywordtype}{double}\ mu\ =\ 0)\ \{}
\DoxyCodeLine{00165\ }
\DoxyCodeLine{00166\ \ \ \ \ \textcolor{keywordtype}{int}\ r\ =\ itops.\mbox{\hyperlink{classcppdlr_1_1imtime__ops_a88f437cb31c98929ab8a1e6dadb174aa}{rank}}();}
\DoxyCodeLine{00167\ }
\DoxyCodeLine{00168\ \ \ \ \ \textcolor{keywordflow}{if}\ \textcolor{keyword}{constexpr}\ (std::floating\_point<Ht>)\ \{\ \textcolor{comment}{//\ If\ h\ is\ scalar,\ return\ scalar-\/valued\ Green's\ function}}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ g\ =\ nda::array<Ht,\ 1>(r);}
\DoxyCodeLine{00170\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ r;\ i++)\ \{\ g(i)\ =\ \mbox{\hyperlink{namespacecppdlr_afc9726e02898098dfff8448f02f5b3c6}{k\_it}}(itops.\mbox{\hyperlink{classcppdlr_1_1imtime__ops_ae20e69067cc04e37fe8448e8d1088776}{get\_itnodes}}(i),\ h\ -\/\ mu,\ beta);\ \}}
\DoxyCodeLine{00171\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ g;}
\DoxyCodeLine{00172\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{\ \textcolor{comment}{//\ Otherwise,\ return\ matrix-\/valued\ Green's\ function}}
\DoxyCodeLine{00173\ }
\DoxyCodeLine{00174\ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ norb\ =\ h.shape(0);}
\DoxyCodeLine{00175\ }
\DoxyCodeLine{00176\ \ \ \ \ \ \ \textcolor{comment}{//\ Diagonalize\ Hamiltonian}}
\DoxyCodeLine{00177\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ [eval,\ evec]\ =\ nda::linalg::eigenelements(h);}
\DoxyCodeLine{00178\ }
\DoxyCodeLine{00179\ \ \ \ \ \ \ \textcolor{comment}{//\ Get\ free\ Green's\ function}}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \textcolor{keyword}{auto}\ g\ =\ nda::array<nda::get\_value\_t<Ht>,\ 3>(r,\ norb,\ norb);}
\DoxyCodeLine{00181\ \ \ \ \ \ \ g\ \ \ \ \ \ =\ 0;}
\DoxyCodeLine{00182\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ r;\ i++)\ \{}
\DoxyCodeLine{00183\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ j\ =\ 0;\ j\ <\ norb;\ j++)\ \{\ g(i,\ j,\ j)\ =\ \mbox{\hyperlink{namespacecppdlr_afc9726e02898098dfff8448f02f5b3c6}{k\_it}}(itops.\mbox{\hyperlink{classcppdlr_1_1imtime__ops_ae20e69067cc04e37fe8448e8d1088776}{get\_itnodes}}(i),\ eval(j)\ -\/\ mu,\ beta);\ \}}
\DoxyCodeLine{00184\ \ \ \ \ \ \ \ \ g(i,\ \_,\ \_)\ =\ matmul(evec,\ matmul(g(i,\ \_,\ \_),\ transpose(conj(evec))));}
\DoxyCodeLine{00185\ \ \ \ \ \ \ \}}
\DoxyCodeLine{00186\ }
\DoxyCodeLine{00187\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ g;}
\DoxyCodeLine{00188\ \ \ \ \ \}}
\DoxyCodeLine{00189\ \ \ \}}
\DoxyCodeLine{00190\ \}\ \textcolor{comment}{//\ namespace\ cppdlr}}
