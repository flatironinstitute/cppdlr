\doxysection{cppdlr\+::imtime\+\_\+ops Class Reference}
\hypertarget{classcppdlr_1_1imtime__ops}{}\label{classcppdlr_1_1imtime__ops}\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\begin{DoxyCompactList}\small\item\em Constructor for \doxylink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}. \end{DoxyCompactList}\item 
...
{\footnotesize template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\T\+::regular\+\_\+type \mbox{\hyperlink{classcppdlr_1_1imtime__ops_adbf464d1761e4c366166b4bb26f2b9cb}{convolve}} (double beta, T const \&fc, T const \&gc, bool time\+\_\+order=false) const
...
{\footnotesize template$<$nda\+::\+Memory\+Array T$>$ }\\auto \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a2f85a500e7581631c164287ff5a75329}{convolve}} (double beta, \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}} statistic, T const \&fc, T const \&gc, bool time\+\_\+order=false) const
\begin{DoxyCompactList}\small\item\em Deprecated overload of convolve method. \end{DoxyCompactList}\item 
...
{\footnotesize template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\nda\+::matrix$<$ S $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_aac344326d87caaabff268ca47e0f8427}{convmat}} (double beta, T const \&fc, bool time\+\_\+order=false) const
...
{\footnotesize template$<$nda\+::\+Memory\+Array T$>$ }\\auto \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a689f31f5920a60448f6c6421a2aec48d}{convmat}} (double beta, \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}} statistic, T const \&fc, bool time\+\_\+order=false) const
\begin{DoxyCompactList}\small\item\em Deprecated overload of convmat method. \end{DoxyCompactList}\item 
{\footnotesize template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\void \mbox{\hyperlink{classcppdlr_1_1imtime__ops_aadebc7d1f47b8f8497c2cca4b0711b69}{convmat\+\_\+inplace}} (nda\+::matrix\+\_\+view$<$ S, nda\+::\+C\+\_\+layout $>$ fconv, double beta, T const \&fc, bool time\+\_\+order=false) const
\begin{DoxyCompactList}\small\item\em Compute matrix of convolution by an imaginary time Green\textquotesingle{}s function in place. \end{DoxyCompactList}\item 
{\footnotesize template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\void \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a9f48c8e4b3164985af73fba0fd28b002}{convmat\+\_\+inplace}} (nda\+::matrix\+\_\+view$<$ S, nda\+::\+C\+\_\+layout $>$ fconv, double beta, \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}} statistic, T const \&fc, bool time\+\_\+order=false) const
\begin{DoxyCompactList}\small\item\em Deprecated overload of convmat\+\_\+inplace method. \end{DoxyCompactList}\item 
...
nda\+::vector\+\_\+const\+\_\+view$<$ double $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_ae20e69067cc04e37fe8448e8d1088776}{get\+\_\+itnodes}} () const
...
\item 
nda\+::vector\+\_\+const\+\_\+view$<$ double $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_ae5f9dc847c716f5d8b0ea92d56777263}{get\+\_\+rfnodes}} () const
...
\item 
nda\+::matrix\+\_\+const\+\_\+view$<$ double $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a6cb8521ca54bb5efa1464693679185ba}{get\+\_\+cf2it}} () const
...
nda\+::matrix\+\_\+const\+\_\+view$<$ double $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a44acd4cd20cbe95632534891644f1806}{get\+\_\+it2cf\+\_\+lu}} () const
...
nda\+::matrix\+\_\+const\+\_\+view$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_aa6caeb28e5c8152483d3c133b047b6fe}{get\+\_\+it2cf\+\_\+zlu}} () const
...
nda\+::vector\+\_\+const\+\_\+view$<$ int $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a44d6669d27cdd0f51d74fa2d7b2885de}{get\+\_\+it2cf\+\_\+piv}} () const
...
\item 
nda\+::matrix\+\_\+const\+\_\+view$<$ double $>$ \mbox{\hyperlink{classcppdlr_1_1imtime__ops_a2c9211118869fa15b9d1e3092d97b716}{get\+\_\+ipmat}} () const
...
\Hypertarget{classcppdlr_1_1imtime__ops_a31b2703038bafa04b59e3731ab0bf234}\label{classcppdlr_1_1imtime__ops_a31b2703038bafa04b59e3731ab0bf234} 
...
Constructor for \doxylink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}. 
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
With SYM the nodes are mirror-\/symmetric about tau=beta/2, which is itself included as a self-\/paired node. SYM therefore requires {\ttfamily dlr\+\_\+rf} of odd rank, as built by build\+\_\+dlr\+\_\+rf with SYM, and throws otherwise. 
\end{DoxyNote}
\Hypertarget{classcppdlr_1_1imtime__ops_a0a1d4dfc2eb1ebc6fbd4cf6b9c13b2d7}\label{classcppdlr_1_1imtime__ops_a0a1d4dfc2eb1ebc6fbd4cf6b9c13b2d7} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!imtime\_ops@{imtime\_ops}}
\index{imtime\_ops@{imtime\_ops}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\hline
\end{DoxyParams}
\Hypertarget{classcppdlr_1_1imtime__ops_a43a9b5fb6aeefad7d8ae6865329e69de}\label{classcppdlr_1_1imtime__ops_a43a9b5fb6aeefad7d8ae6865329e69de} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!imtime\_ops@{imtime\_ops}}
\index{imtime\_ops@{imtime\_ops}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\Hypertarget{classcppdlr_1_1imtime__ops_a8da78cf54d39d48d2be19ad1f146b03c}\label{classcppdlr_1_1imtime__ops_a8da78cf54d39d48d2be19ad1f146b03c} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!imtime\_ops@{imtime\_ops}}
\index{imtime\_ops@{imtime\_ops}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\Hypertarget{classcppdlr_1_1imtime__ops_a318b0b4409d0488814bb8db12c8b0611}\label{classcppdlr_1_1imtime__ops_a318b0b4409d0488814bb8db12c8b0611} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The given evaluation point must be scaled to the interval \mbox{[}0, 1\mbox{]} (rather than \mbox{[}0, beta\mbox{]}) and then given in the relative time format. Please see the "{}\+Imaginary time point format"{} section in the Background page of the documentation for more information. 
\end{DoxyNote}
\Hypertarget{classcppdlr_1_1imtime__ops_a12761a877407fc347dc695da4b2d7f3d}\label{classcppdlr_1_1imtime__ops_a12761a877407fc347dc695da4b2d7f3d} 
...
The given evaluation point must be scaled to the interval \mbox{[}0, 1\mbox{]} (rather than \mbox{[}0, beta\mbox{]}) and then given in the relative time format. Please see the "{}\+Imaginary time point format"{} section in the Background page of the documentation for more information. 
\end{DoxyNote}
\Hypertarget{classcppdlr_1_1imtime__ops_a6f6d71c061aec134df9edf1255e19dfb}\label{classcppdlr_1_1imtime__ops_a6f6d71c061aec134df9edf1255e19dfb} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a689f31f5920a60448f6c6421a2aec48d}\label{classcppdlr_1_1imtime__ops_a689f31f5920a60448f6c6421a2aec48d} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convmat@{convmat}}
\index{convmat@{convmat}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convmat()}{convmat()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T$>$ \\
auto cppdlr\+::imtime\+\_\+ops\+::convmat (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{\mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}}}]{statistic,  }\item[{T const \&}]{fc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Deprecated overload of convmat method. 

This version includes an unused extra parameter for backward compatibility.

\begin{DoxyRefDesc}{Deprecated}
\item[\mbox{\hyperlink{deprecated__deprecated000002}{Deprecated}}]Use convmat(beta, fc, time\+\_\+order) instead; this works for both fermionic and bosonic functions. \end{DoxyRefDesc}
\Hypertarget{classcppdlr_1_1imtime__ops_aac344326d87caaabff268ca47e0f8427}\label{classcppdlr_1_1imtime__ops_aac344326d87caaabff268ca47e0f8427} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convmat@{convmat}}
\index{convmat@{convmat}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convmat()}{convmat()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ \\
nda\+::matrix$<$ S $>$ cppdlr\+::imtime\+\_\+ops\+::convmat (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{T const \&}]{fc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Compute matrix of convolution by an imaginary time Green\textquotesingle{}s function. 

The convolution of f and g is defined as h(t) = (f \texorpdfstring{$\ast$}{*} g)(t) = int\+\_\+0\texorpdfstring{$^\wedge$}{\string^}beta f(t-\/t\textquotesingle{}) g(t\textquotesingle{}) dt\textquotesingle{}, where fermionic/bosonic antiperiodicity/periodicity are used to define the Green\textquotesingle{}s functions on (-\/beta, 0). This method takes the DLR coefficients of f as input and returns the matrix of convolution by f. This matrix can be applied to the values of g on the DLR imaginary time grid, to produce the values of h on the DLR imaginary time grid.

By specifying the {\ttfamily time\+\_\+order} flag, this method can be used to compute the time-\/ordered convolution of f and g, defined as h(t) = (f \texorpdfstring{$\ast$}{*} g)(t) = int\+\_\+0\texorpdfstring{$^\wedge$}{\string^}tau f(t-\/t\textquotesingle{}) g(t\textquotesingle{}) dt\textquotesingle{}.
...
\hline
\mbox{\texttt{ in}}  & {\em statistic} & Fermionic ("{}\+Fermion"{} or 1) or bosonic ("{}\+Boson"{} or 0) \\
\hline
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
Whereas the method \doxylink{classcppdlr_1_1imtime__ops_adbf464d1761e4c366166b4bb26f2b9cb}{imtime\+\_\+ops\+::convolve} takes the DLR coefficients of f and g as input and computes their convolution h directly, this method returns a matrix which should be applied to the DLR imaginary time grid values of g, rather than its DLR coefficients, in to order to obtain the convolution h. The purpose of this is to make the input and output representations of the convolution matrix equal, which is often convenient in practice.

In the case of matrix-\/valued Green\textquotesingle{}s functions, we think of the matrix of convolution by f as an r\texorpdfstring{$\ast$}{*}norb1 x r\texorpdfstring{$\ast$}{*}norb2 matrix, or a block r x r matrix of norb1 x norb2 blocks. Here r is the DLR rank and norb1, norb2 are the number of row and column orbital indices, respectively. This matrix would then be applied to a Green\textquotesingle{}s function g, represented as an r\texorpdfstring{$\ast$}{*}norb2 x r\texorpdfstring{$\ast$}{*}norb3 matrix, or a block r x 1 matrix of norb2 x norb3 blocks. 
\end{DoxyNote}
\Hypertarget{classcppdlr_1_1imtime__ops_a9f48c8e4b3164985af73fba0fd28b002}\label{classcppdlr_1_1imtime__ops_a9f48c8e4b3164985af73fba0fd28b002} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convmat\_inplace@{convmat\_inplace}}
\index{convmat\_inplace@{convmat\_inplace}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convmat\_inplace()}{convmat\_inplace()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ \\
void cppdlr\+::imtime\+\_\+ops\+::convmat\+\_\+inplace (\begin{DoxyParamCaption}\item[{nda\+::matrix\+\_\+view$<$ S, nda\+::\+C\+\_\+layout $>$}]{fconv,  }\item[{double}]{beta,  }\item[{\mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}}}]{statistic,  }\item[{T const \&}]{fc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Deprecated overload of convmat\+\_\+inplace method. 

This version includes an unused extra parameter for backward compatibility.

\begin{DoxyRefDesc}{Deprecated}
\item[\mbox{\hyperlink{deprecated__deprecated000003}{Deprecated}}]Use convmat\+\_\+inplace(fconv, beta, fc, time\+\_\+order) instead; this works for both fermionic and bosonic functions. \end{DoxyRefDesc}
\Hypertarget{classcppdlr_1_1imtime__ops_aadebc7d1f47b8f8497c2cca4b0711b69}\label{classcppdlr_1_1imtime__ops_aadebc7d1f47b8f8497c2cca4b0711b69} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convmat\_inplace@{convmat\_inplace}}
\index{convmat\_inplace@{convmat\_inplace}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convmat\_inplace()}{convmat\_inplace()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ \\
void cppdlr\+::imtime\+\_\+ops\+::convmat\+\_\+inplace (\begin{DoxyParamCaption}\item[{nda\+::matrix\+\_\+view$<$ S, nda\+::\+C\+\_\+layout $>$}]{fconv,  }\item[{double}]{beta,  }\item[{T const \&}]{fc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Compute matrix of convolution by an imaginary time Green\textquotesingle{}s function in place. 
...
\begin{DoxyParams}[1]{Parameters}
 & {\em \mbox{[}in/out\mbox{]}} & fconv Convolution matrix from DLR coefficients to DLR grid \\
\hline
\mbox{\texttt{ in}}  & {\em beta} & Inverse temperature \\
\hline
\mbox{\texttt{ in}}  & {\em statistic} & Fermionic ("{}\+Fermion"{} or 1) or bosonic ("{}\+Boson"{} or 0) \\
...
\end{DoxyParams}
\begin{DoxyNote}{Note}
This function builds the matrix of convolution, in place, in the provided matrix {\ttfamily fconv}. This makes it possible to control the memory allocation externally. If this is not a concern, we advise using the {\ttfamily convmat(...)} function instead of {\ttfamily convmat\+\_\+inplace(...)}.

Whereas the method \doxylink{classcppdlr_1_1imtime__ops_adbf464d1761e4c366166b4bb26f2b9cb}{imtime\+\_\+ops\+::convolve} takes the DLR coefficients of f and g as input and computes their convolution h directly, this method returns a matrix which should be applied to the DLR imaginary time grid values of g, rather than its DLR coefficients, in to order to obtain the convolution h. The purpose of this is to make the input and output representations of the convolution matrix equal, which is often convenient in practice.

In the case of matrix-\/valued Green\textquotesingle{}s functions, we think of the matrix of convolution by f as an r\texorpdfstring{$\ast$}{*}norb1 x r\texorpdfstring{$\ast$}{*}norb2 matrix, or a block r x r matrix of norb1 x norb2 blocks. Here r is the DLR rank and norb1, norb2 are the number of row and column orbital indices, respectively. This matrix would then be applied to a Green\textquotesingle{}s function g, represented as an r\texorpdfstring{$\ast$}{*}norb2 x r\texorpdfstring{$\ast$}{*}norb3 matrix, or a block r x 1 matrix of norb2 x norb3 blocks. 
\end{DoxyNote}
\Hypertarget{classcppdlr_1_1imtime__ops_a2f85a500e7581631c164287ff5a75329}\label{classcppdlr_1_1imtime__ops_a2f85a500e7581631c164287ff5a75329} 
...
\doxysubsubsection{\texorpdfstring{convolve()}{convolve()}\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T$>$ \\
auto cppdlr\+::imtime\+\_\+ops\+::convolve (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{\mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}}}]{statistic,  }\item[{T const \&}]{fc,  }\item[{T const \&}]{gc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}



Deprecated overload of convolve method. 

This version includes an unused extra parameter for backward compatibility.

\begin{DoxyRefDesc}{Deprecated}
\item[\mbox{\hyperlink{deprecated__deprecated000001}{Deprecated}}]Use convolve(beta, fc, gc, time\+\_\+order) instead; this works for both fermionic and bosonic functions. \end{DoxyRefDesc}
\Hypertarget{classcppdlr_1_1imtime__ops_adbf464d1761e4c366166b4bb26f2b9cb}\label{classcppdlr_1_1imtime__ops_adbf464d1761e4c366166b4bb26f2b9cb} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convolve@{convolve}}
\index{convolve@{convolve}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convolve()}{convolve()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ \\
T\+::regular\+\_\+type cppdlr\+::imtime\+\_\+ops\+::convolve (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{T const \&}]{fc,  }\item[{T const \&}]{gc,  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
The convolution is computed on-\/the-\/fly in O(r\texorpdfstring{$^\wedge$}{\string^}2) operations using the method described in Appendix A of
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Values of h = f \texorpdfstring{$\ast$}{*} g on DLR imaginary time grid 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a87b3e21ae66c97691a4580335795f77f}\label{classcppdlr_1_1imtime__ops_a87b3e21ae66c97691a4580335795f77f} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!convolve@{convolve}}
\index{convolve@{convolve}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
\doxysubsubsection{\texorpdfstring{convolve()}{convolve()}\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
...
Values of h = f \texorpdfstring{$\ast$}{*} g on DLR imaginary time grid 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a6257e0b3f43733c5ac06c8af11a47bb3}\label{classcppdlr_1_1imtime__ops_a6257e0b3f43733c5ac06c8af11a47bb3} 
...
\hline
\end{DoxyParams}
\Hypertarget{classcppdlr_1_1imtime__ops_a6a81a99b2858defa9513a395bd35e2bf}\label{classcppdlr_1_1imtime__ops_a6a81a99b2858defa9513a395bd35e2bf} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a6cb8521ca54bb5efa1464693679185ba}\label{classcppdlr_1_1imtime__ops_a6cb8521ca54bb5efa1464693679185ba} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a2c9211118869fa15b9d1e3092d97b716}\label{classcppdlr_1_1imtime__ops_a2c9211118869fa15b9d1e3092d97b716} 
...
f\texorpdfstring{$^\wedge$}{\string^}T M g = 1/beta int\+\_\+0\texorpdfstring{$^\wedge$}{\string^}beta dt f(t) g(t).

\begin{DoxyReturn}{Returns}
Inner product matrix 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a44acd4cd20cbe95632534891644f1806}\label{classcppdlr_1_1imtime__ops_a44acd4cd20cbe95632534891644f1806} 
...
LU factors 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a44d6669d27cdd0f51d74fa2d7b2885de}\label{classcppdlr_1_1imtime__ops_a44d6669d27cdd0f51d74fa2d7b2885de} 
...
LU pivots 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_aa6caeb28e5c8152483d3c133b047b6fe}\label{classcppdlr_1_1imtime__ops_aa6caeb28e5c8152483d3c133b047b6fe} 
...
{\footnotesize\ttfamily nda\+::matrix\+\_\+const\+\_\+view$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ cppdlr\+::imtime\+\_\+ops\+::get\+\_\+it2cf\+\_\+zlu (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [inline]}}
...
LU factors 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_ae20e69067cc04e37fe8448e8d1088776}\label{classcppdlr_1_1imtime__ops_ae20e69067cc04e37fe8448e8d1088776} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_aec1395480d77a2f400b62171e553b0f4}\label{classcppdlr_1_1imtime__ops_aec1395480d77a2f400b62171e553b0f4} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!get\_itnodes@{get\_itnodes}}
\index{get\_itnodes@{get\_itnodes}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\Hypertarget{classcppdlr_1_1imtime__ops_ae5f9dc847c716f5d8b0ea92d56777263}\label{classcppdlr_1_1imtime__ops_ae5f9dc847c716f5d8b0ea92d56777263} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_ac58745b133d7a289d897c920ee89f671}\label{classcppdlr_1_1imtime__ops_ac58745b133d7a289d897c920ee89f671} 
\index{cppdlr::imtime\_ops@{cppdlr::imtime\_ops}!get\_rfnodes@{get\_rfnodes}}
\index{get\_rfnodes@{get\_rfnodes}!cppdlr::imtime\_ops@{cppdlr::imtime\_ops}}
...
\Hypertarget{classcppdlr_1_1imtime__ops_a649d9f6c3d257661818c3f473f49f57a}\label{classcppdlr_1_1imtime__ops_a649d9f6c3d257661818c3f473f49f57a} 
...
\Hypertarget{classcppdlr_1_1imtime__ops_aaaa4303e1ee0897417308f380bb75de8}\label{classcppdlr_1_1imtime__ops_aaaa4303e1ee0897417308f380bb75de8} 
...
(f,g) = 1/beta \texorpdfstring{$\ast$}{*} sum\+\_\+\{ij\} int\+\_\+0\texorpdfstring{$^\wedge$}{\string^}beta dt conj(f\+\_\+ij(t)) g\+\_\+ij(t),
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a6ce574cd38bdb5bee21d499710f2e8fa}\label{classcppdlr_1_1imtime__ops_a6ce574cd38bdb5bee21d499710f2e8fa} 
...
\Hypertarget{classcppdlr_1_1imtime__ops_a88f437cb31c98929ab8a1e6dadb174aa}\label{classcppdlr_1_1imtime__ops_a88f437cb31c98929ab8a1e6dadb174aa} 
...
DLR rank 
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a0ee9bfed6fc9facf2d25cea9868a3af6}\label{classcppdlr_1_1imtime__ops_a0ee9bfed6fc9facf2d25cea9868a3af6} 
...
\end{DoxyReturn}
\Hypertarget{classcppdlr_1_1imtime__ops_a3a47942235e7330cc6d392dc881d256f}\label{classcppdlr_1_1imtime__ops_a3a47942235e7330cc6d392dc881d256f} 
...
Initialize matrix of the reflection G(tau) -\/\texorpdfstring{$>$}{>} G(beta -\/ tau) acting on the values of the Green\textquotesingle{}s function at the DLR imaginary time nodes. This matrix is required for the reflect method. It is called automatically the first time the reflect method is called, but it may also be called manually to avoid the additional overhead of the first call to reflect. \Hypertarget{classcppdlr_1_1imtime__ops_af958ce61d0c823b2a356b13c3fa10f3d}\label{classcppdlr_1_1imtime__ops_af958ce61d0c823b2a356b13c3fa10f3d} 
...
\hline
\end{DoxyParams}
\Hypertarget{classcppdlr_1_1imtime__ops_ae6116f42e1f17050404974d0d6d3d226}\label{classcppdlr_1_1imtime__ops_ae6116f42e1f17050404974d0d6d3d226} 
...
\hline
\mbox{\texttt{ in}}  & {\em transpose} & Transpose values -\/\texorpdfstring{$>$}{>} coefficients transformation (default is false)\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
By setting the optional argument {\ttfamily transpose} to true, this method applies the transpose of the values -\/\texorpdfstring{$>$}{>} coefficients transformation. This is useful for constructing matrices of linear operators which act on vectors of DLR grid values, rather than DLR coefficients. As an example, suppose L is a linear functional such that L\mbox{[}G\mbox{]} = c, G is a Green\textquotesingle{}s function and c is a scalar. If gc is the vector of DLR coefficient of G, then we can represent L by a vector l, with entries given by the action of L on the DLR basis functions, and we have l\texorpdfstring{$^\wedge$}{\string^}T \texorpdfstring{$\ast$}{*} gc = c. Then
\end{DoxyNote}
c = l\texorpdfstring{$^\wedge$}{\string^}T \texorpdfstring{$\ast$}{*} it2cf \texorpdfstring{$\ast$}{*} g = (it2cf\texorpdfstring{$^\wedge$}{\string^}T \texorpdfstring{$\ast$}{*} l)\texorpdfstring{$^\wedge$}{\string^}T \texorpdfstring{$\ast$}{*} g,

where g is the vector of values of G at the DLR nodes, and it2cf is the imaginary time values -\/\texorpdfstring{$>$}{>} coefficients matrix. Thus it2cf\texorpdfstring{$^\wedge$}{\string^}T \texorpdfstring{$\ast$}{*} l is the vector of the linear operator T acting on the vector of values of G at the DLR nodes, and can be precomputed using the vals2coefs method with the transpose option set to true. 

\doxysubsection{Friends And Related Symbol Documentation}
\Hypertarget{classcppdlr_1_1imtime__ops_a02e5f8519e54734a74b94226d10e082d}\label{classcppdlr_1_1imtime__ops_a02e5f8519e54734a74b94226d10e082d} 
...
\Hypertarget{classcppdlr_1_1imtime__ops_a0eec6aaaea35d7bba7e92951a0de76db}\label{classcppdlr_1_1imtime__ops_a0eec6aaaea35d7bba7e92951a0de76db} 
...
\Hypertarget{classcppdlr_1_1imtime__ops_a83e9085aca345c3bf889ae006f0fdb3d}\label{classcppdlr_1_1imtime__ops_a83e9085aca345c3bf889ae006f0fdb3d} 
...
LU factors (LAPACK format) of imaginary time vals -\/\texorpdfstring{$>$}{>} coefs matrix. 

\Hypertarget{classcppdlr_1_1imtime__ops_a7cd0e6b5498400d3afade53a6ebab389}\label{classcppdlr_1_1imtime__ops_a7cd0e6b5498400d3afade53a6ebab389} 
...
LU pivots (LAPACK format) of imaginary time vals -\/\texorpdfstring{$>$}{>} coefs matrix. 

\Hypertarget{classcppdlr_1_1imtime__ops_a4868c3d774292b4d3610ac3225682bc0}\label{classcppdlr_1_1imtime__ops_a4868c3d774292b4d3610ac3225682bc0} 
...
{\footnotesize\ttfamily nda\+::matrix$<$\mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}}$>$ cppdlr\+::imtime\+\_\+ops\+::zlu}
