...
nda\+::vector$<$ double $>$ \mbox{\hyperlink{namespacecppdlr_a134a65b6f951a80cb99e41d52d89f0ed}{build\+\_\+dlr\+\_\+rf}} (double lambda, double eps, \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}} statistic, bool symmetrize)
...
{\footnotesize template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = get\+\_\+value\+\_\+t$<$\+T$>$, nda\+::\+Memory\+Vector V$>$ }\\std\+::tuple$<$ typename T\+::regular\+\_\+type, nda\+::vector$<$ double $>$, nda\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{namespacecppdlr_a87cd86b43bae8fd0272a4f764bcd163f}{pivrgs\+\_\+sym}} (T const \&a, V const \&v, double eps)
...
\end{DoxyNote}
\mbox{\Hypertarget{namespacecppdlr_a134a65b6f951a80cb99e41d52d89f0ed}\label{namespacecppdlr_a134a65b6f951a80cb99e41d52d89f0ed}} 
\index{cppdlr@{cppdlr}!build\_dlr\_rf@{build\_dlr\_rf}}
\index{build\_dlr\_rf@{build\_dlr\_rf}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{build\_dlr\_rf()}{build\_dlr\_rf()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily nda\+::vector$<$ double $>$ cppdlr\+::build\+\_\+dlr\+\_\+rf (\begin{DoxyParamCaption}\item[{double}]{lambda,  }\item[{double}]{eps,  }\item[{\mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}}}]{statistic,  }\item[{bool}]{symmetrize }\end{DoxyParamCaption})}
...
\mbox{\texttt{ in}}  & {\em eps} & Accuracy of DLR basis \\
\hline
\mbox{\texttt{ in}}  & {\em statistic} & Particle statistics\+: Boson or Fermion \\
\hline
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
In case Boson and SYM options are selected, we enforce that omega = 0 is chosen as a DLR frequency. For an explanation, please see the \char`\"{}\+Symmetrized DLR grids\char`\"{} subsection in the \char`\"{}\+Background\char`\"{} section of the documentation. 
\end{DoxyNote}
...
\doxysubsubsection{\texorpdfstring{build\_k\_it()}{build\_k\_it()}\hspace{0.1cm}{\footnotesize\ttfamily [1/3]}}
...
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{build\_k\_it()}{build\_k\_it()}\hspace{0.1cm}{\footnotesize\ttfamily [2/3]}}
...
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{build\_k\_it()}{build\_k\_it()}\hspace{0.1cm}{\footnotesize\ttfamily [3/3]}}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The input matrix A must have an even number of rows. The symmetrization condition is that if A(i,\+:), the ith row of A, is selected as a pivot, then A(m-\/i-\/1,\+:) is also selected as a pivot. Here, m is the row dimension of A, and A is zero-\/indexed. 
\end{DoxyNote}
\mbox{\Hypertarget{namespacecppdlr_a87cd86b43bae8fd0272a4f764bcd163f}\label{namespacecppdlr_a87cd86b43bae8fd0272a4f764bcd163f}} 
\index{cppdlr@{cppdlr}!pivrgs\_sym@{pivrgs\_sym}}
\index{pivrgs\_sym@{pivrgs\_sym}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{pivrgs\_sym()}{pivrgs\_sym()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = get\+\_\+value\+\_\+t$<$\+T$>$, nda\+::\+Memory\+Vector V$>$ \\
std\+::tuple$<$typename T\+::regular\+\_\+type, nda\+::vector$<$double$>$, nda\+::vector$<$int$>$ $>$ cppdlr\+::pivrgs\+\_\+sym (\begin{DoxyParamCaption}\item[{T const \&}]{a,  }\item[{V const \&}]{v,  }\item[{double}]{eps }\end{DoxyParamCaption})}



Symmetrized rank-\/revealing pivoted reorthogonalized Gram-\/\+Schmidt, with matrix augmented by a vector. 

Determine the epsilon-\/rank of a matrix, augmented with a row vector, and return an orthogonal basis of the epsilon-\/row space of the augmented matrix, enforcing symmetrization of pivots and the selection of the provided vector.
