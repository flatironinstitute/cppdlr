\doxysection{cppdlr Namespace Reference}
\hypertarget{namespacecppdlr}{}\label{namespacecppdlr}\index{cppdlr@{cppdlr}}
...
\begin{DoxyCompactItemize}
\item 
nda\+::vector$<$ double $>$ \mbox{\hyperlink{namespacecppdlr_a72bd9e9181d379daa28fb3d96bc5ebca}{build\+\_\+rf\+\_\+fine}} (\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&fine, bool symmetrize=false)
\begin{DoxyCompactList}\small\item\em Build fine composite Chebyshev grid in real frequency. \end{DoxyCompactList}\item 
std\+::tuple$<$ nda\+::vector$<$ double $>$, nda\+::vector$<$ double $>$ $>$ \mbox{\hyperlink{namespacecppdlr_ad1e8fc182e3736d3324acdb200e1e242}{build\+\_\+it\+\_\+fine}} (\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&fine, bool symmetrize=false)
...
\begin{DoxyCompactList}\small\item\em Get imaginary time discretization of analytic continuation kernel with L\texorpdfstring{$^\wedge$}{\string^}2 weighting.   \end{DoxyCompactList}\item 
std\+::tuple$<$ double, double $>$ \mbox{\hyperlink{namespacecppdlr_a9b0726a01d8e6a062f8abc1fc9fa1320}{geterr\+\_\+k\+\_\+it}} (\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&fine, nda\+::vector\+\_\+const\+\_\+view$<$ double $>$ t, nda\+::vector\+\_\+const\+\_\+view$<$ double $>$ om, nda\+::matrix\+\_\+const\+\_\+view$<$ double $>$ kmat)
...
nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ \mbox{\hyperlink{namespacecppdlr_a988f80420d11cd80ac3803bd3bd429c0}{build\+\_\+k\+\_\+if}} (int nmax, nda\+::vector\+\_\+const\+\_\+view$<$ double $>$ om, \mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}} statistic)
...
requires (std\+::floating\+\_\+point$<$Ht$>$ \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} nda\+::\+Memory\+Matrix$<$Ht$>$)}\\auto \mbox{\hyperlink{namespacecppdlr_a02424caf43ace0c3330b2fa03f706400}{free\+\_\+gf}} (double beta, \mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&itops, Ht const \&h, double mu=0, bool time\+\_\+order=false)
...
{\footnotesize template$<$typename Ht $>$ \newline
requires (std\+::floating\+\_\+point$<$Ht$>$ \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} nda\+::\+Memory\+Matrix$<$Ht$>$)}\\auto \mbox{\hyperlink{namespacecppdlr_a4b753b1a7de53aff215a230206908e6d}{free\+\_\+gf}} (double beta, \mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&itops, Ht const \&h, bool time\+\_\+order)
\begin{DoxyCompactList}\small\item\em Compute free-\/particle imaginary time Green\textquotesingle{}s function for a given Hamiltonian. \end{DoxyCompactList}\item 
nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ \mbox{\hyperlink{namespacecppdlr_a2a7a1e02824dc3fde4cb8618fa2e1463}{build\+\_\+if2it}} (\mbox{\hyperlink{classcppdlr_1_1imfreq__ops}{imfreq\+\_\+ops}} const \&ifops, \mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&itops)
\begin{DoxyCompactList}\small\item\em Build matrix mapping DLR imaginary frequency grid values to DLR imaginary time grid values. \end{DoxyCompactList}\item 
nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ \mbox{\hyperlink{namespacecppdlr_a5ed3d6913053f78b949261e92c980f51}{build\+\_\+it2if}} (\mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&itops, \mbox{\hyperlink{classcppdlr_1_1imfreq__ops}{imfreq\+\_\+ops}} const \&ifops)
\begin{DoxyCompactList}\small\item\em Build matrix mapping DLR imaginary time grid values to DLR imaginary frequency grid values. \end{DoxyCompactList}\item 
...
double \mbox{\hyperlink{namespacecppdlr_a767cf14e0aef568fefdb0386d255b510}{normsq}} (nda\+::\+Memory\+Vector auto const \&v)
\item 
{\footnotesize template$<$typename V $>$ }\\bool \mbox{\hyperlink{namespacecppdlr_a721215e26c8f2e4de53d07f34c517823}{flip\+\_\+to\+\_\+mirror}} (V const \&piv, long mirror\+\_\+max)
\begin{DoxyCompactList}\small\item\em Decide whether a selected DLR node set should be flipped to its mirror image. \end{DoxyCompactList}\item 
{\footnotesize template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\std\+::tuple$<$ typename T\+::regular\+\_\+type, nda\+::vector$<$ double $>$, nda\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{namespacecppdlr_a1d0c839b446002a589c9cc22534967b6}{pivrgs}} (T const \&a, double eps)
\begin{DoxyCompactList}\small\item\em Rank-\/revealing pivoted reorthogonalized Gram-\/\+Schmidt. \end{DoxyCompactList}\item 
{\footnotesize template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\std\+::tuple$<$ typename T\+::regular\+\_\+type, nda\+::vector$<$ double $>$, nda\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{namespacecppdlr_ae2becc5e7e7dfe9a59d7a45c309a2e47}{pivrgs\+\_\+sym}} (T const \&a, double eps)
...
{\footnotesize template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ }\\std\+::tuple$<$ typename T\+::regular\+\_\+type, nda\+::vector$<$ double $>$, nda\+::vector$<$ int $>$ $>$ \mbox{\hyperlink{namespacecppdlr_ad64323a06309e2802fb97b93e3e24c2d}{pivrgs\+\_\+sym}} (T const \&a, int r)
...
\begin{DoxyCompactItemize}
\item 
using \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} = std\+::complex$<$ double $>$
\item 
{\footnotesize template$<$nda\+::\+Memory\+Array T$>$ }\\using \mbox{\hyperlink{namespacecppdlr_af914cc6f80f2a540846205c0a2ae1b73}{make\+\_\+real\+\_\+t}} = decltype(make\+\_\+regular(nda\+::real(std\+::declval$<$ T $>$())))
...
{\footnotesize template$<$nda\+::\+Memory\+Array T$>$ }\\using \mbox{\hyperlink{namespacecppdlr_af7426dd83d2c831f6ae3fa9b8e6172ad}{make\+\_\+cplx\+\_\+t}} = decltype(make\+\_\+regular(std\+::declval$<$ T $>$() \texorpdfstring{$\ast$}{*}1i))
...
\Hypertarget{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}\label{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9} 
\index{cppdlr@{cppdlr}!dcomplex@{dcomplex}}
\index{dcomplex@{dcomplex}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{dcomplex}{dcomplex}}
{\footnotesize\ttfamily typedef std\+::complex$<$ double $>$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{cppdlr\+::dcomplex}}}

\Hypertarget{namespacecppdlr_ac23dfec829ec6ed8deec469faeea3981}\label{namespacecppdlr_ac23dfec829ec6ed8deec469faeea3981} 
...
\Hypertarget{namespacecppdlr_af7426dd83d2c831f6ae3fa9b8e6172ad}\label{namespacecppdlr_af7426dd83d2c831f6ae3fa9b8e6172ad} 
...
using \mbox{\hyperlink{namespacecppdlr_af7426dd83d2c831f6ae3fa9b8e6172ad}{cppdlr\+::make\+\_\+cplx\+\_\+t}} = typedef decltype(make\+\_\+regular(std\+::declval$<$T$>$() \texorpdfstring{$\ast$}{*} 1i))}



Get complex-\/valued type corresponding to type of given nda Memory\+Array. 

\Hypertarget{namespacecppdlr_af914cc6f80f2a540846205c0a2ae1b73}\label{namespacecppdlr_af914cc6f80f2a540846205c0a2ae1b73} 
...
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array T$>$ \\
using \mbox{\hyperlink{namespacecppdlr_af914cc6f80f2a540846205c0a2ae1b73}{cppdlr\+::make\+\_\+real\+\_\+t}} = typedef decltype(make\+\_\+regular(nda\+::real(std\+::declval$<$T$>$())))}
...
\Hypertarget{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6d}\label{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6d} 
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{NONSYM@{NONSYM}!cppdlr@{cppdlr}}\index{cppdlr@{cppdlr}!NONSYM@{NONSYM}}}\Hypertarget{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6da320d20930f8ff7ba461e55e30ea405c7}\label{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6da320d20930f8ff7ba461e55e30ea405c7} 
NONSYM&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{SYM@{SYM}!cppdlr@{cppdlr}}\index{cppdlr@{cppdlr}!SYM@{SYM}}}\Hypertarget{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6da2926e3338e8cc759a75b8c9fac6f7d61}\label{namespacecppdlr_afa13d278b5eff503e3399f445f84ab6da2926e3338e8cc759a75b8c9fac6f7d61} 
SYM&\\
\hline

\end{DoxyEnumFields}
\Hypertarget{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}\label{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435} 
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{Boson@{Boson}!cppdlr@{cppdlr}}\index{cppdlr@{cppdlr}!Boson@{Boson}}}\Hypertarget{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435a6a57173d6b5be36c6815ab715152716d}\label{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435a6a57173d6b5be36c6815ab715152716d} 
Boson&\\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{Fermion@{Fermion}!cppdlr@{cppdlr}}\index{cppdlr@{cppdlr}!Fermion@{Fermion}}}\Hypertarget{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435ac01c1699bb87ec8268ee33f7f20d84ee}\label{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435ac01c1699bb87ec8268ee33f7f20d84ee} 
Fermion&\\
\hline
...
\Hypertarget{namespacecppdlr_a791b659aaebe1e52cf12edb3b089b224}\label{namespacecppdlr_a791b659aaebe1e52cf12edb3b089b224} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
Converting a point from relative to absolute time format will, in general, result in a loss of relative accuracy in the location of the point if the point is close to t = 1. For example, in three-\/digit arithmetic, the point t = 0.\+999111 could be stored in relative format as t\texorpdfstring{$^\wedge$}{\string^}\texorpdfstring{$\ast$}{*} = -\/0.\+889e-\/3, but only as t = 0.\+999 in absolute format. For more information on the relative time format used in cppdlr, please see the Background section of the cppdlr documentation.   
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a103a8aae4c8af512d2682d381a676561}\label{namespacecppdlr_a103a8aae4c8af512d2682d381a676561} 
\index{cppdlr@{cppdlr}!abs2rel@{abs2rel}}
\index{abs2rel@{abs2rel}!cppdlr@{cppdlr}}
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a93826a1ab8ed29d304e0194fefd4e19c}\label{namespacecppdlr_a93826a1ab8ed29d304e0194fefd4e19c} 
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a623b3f78817239e2d1653be8972cc5f1}\label{namespacecppdlr_a623b3f78817239e2d1653be8972cc5f1} 
...
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array Ta, nda\+::\+Memory\+Array Tb, nda\+::\+Scalar Sa = nda\+::get\+\_\+value\+\_\+t$<$\+Ta$>$, nda\+::\+Scalar Sb = nda\+::get\+\_\+value\+\_\+t$<$\+Tb$>$, nda\+::\+Scalar S = std\+::common\+\_\+type\+\_\+t$<$\+Sa, Sb$>$$>$ \\
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_aa355c3aaf829296d7e5869eff98fedd1}\label{namespacecppdlr_aa355c3aaf829296d7e5869eff98fedd1} 
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ace84f47b6cc94a562dfd5207791c27b0}\label{namespacecppdlr_ace84f47b6cc94a562dfd5207791c27b0} 
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a07f27d33c07f08031768f0844d14724e}\label{namespacecppdlr_a07f27d33c07f08031768f0844d14724e} 
\index{cppdlr@{cppdlr}!build\_dlr\_rf@{build\_dlr\_rf}}
\index{build\_dlr\_rf@{build\_dlr\_rf}!cppdlr@{cppdlr}}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
With SYM the DLR frequencies are mirror-\/symmetric about omega=0, which is itself included as a self-\/paired node, so the rank is odd. 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a2a7a1e02824dc3fde4cb8618fa2e1463}\label{namespacecppdlr_a2a7a1e02824dc3fde4cb8618fa2e1463} 
\index{cppdlr@{cppdlr}!build\_if2it@{build\_if2it}}
\index{build\_if2it@{build\_if2it}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{build\_if2it()}{build\_if2it()}}
{\footnotesize\ttfamily nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ cppdlr\+::build\+\_\+if2it (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcppdlr_1_1imfreq__ops}{imfreq\+\_\+ops}} const \&}]{ifops,  }\item[{\mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&}]{itops }\end{DoxyParamCaption})}



Build matrix mapping DLR imaginary frequency grid values to DLR imaginary time grid values. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em ifops} & DLR imaginary frequency operations object \\
\hline
\mbox{\texttt{ in}}  & {\em itops} & DLR imaginary time operations object\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Matrix mapping imaginary frequency grid values to imaginary time grid values (without 1/beta factor) 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a5ed3d6913053f78b949261e92c980f51}\label{namespacecppdlr_a5ed3d6913053f78b949261e92c980f51} 
\index{cppdlr@{cppdlr}!build\_it2if@{build\_it2if}}
\index{build\_it2if@{build\_it2if}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{build\_it2if()}{build\_it2if()}}
{\footnotesize\ttfamily nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ cppdlr\+::build\+\_\+it2if (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&}]{itops,  }\item[{\mbox{\hyperlink{classcppdlr_1_1imfreq__ops}{imfreq\+\_\+ops}} const \&}]{ifops }\end{DoxyParamCaption})}



Build matrix mapping DLR imaginary time grid values to DLR imaginary frequency grid values. 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Matrix mapping imaginary time grid values to imaginary frequency grid values (without beta factor) 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ad1e8fc182e3736d3324acdb200e1e242}\label{namespacecppdlr_ad1e8fc182e3736d3324acdb200e1e242} 
...
{\footnotesize\ttfamily std\+::tuple$<$ nda\+::vector$<$ double $>$, nda\+::vector$<$ double $>$ $>$ cppdlr\+::build\+\_\+it\+\_\+fine (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&}]{fine,  }\item[{bool}]{symmetrize = {\ttfamily false} }\end{DoxyParamCaption})}
...
\hline
\mbox{\texttt{ in}}  & {\em symmetrize} & If true, include tau=beta/2 with zero quadrature weight, making the grid odd-\/sized and mirror-\/symmetric about it.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a988f80420d11cd80ac3803bd3bd429c0}\label{namespacecppdlr_a988f80420d11cd80ac3803bd3bd429c0} 
...
{\footnotesize\ttfamily nda\+::matrix$<$ \mbox{\hyperlink{namespacecppdlr_a7b5392bb6f0a8155f1f19cab3bd042e9}{dcomplex}} $>$ cppdlr\+::build\+\_\+k\+\_\+if (\begin{DoxyParamCaption}\item[{int}]{nmax,  }\item[{nda\+::vector\+\_\+const\+\_\+view$<$ double $>$}]{om,  }\item[{\mbox{\hyperlink{namespacecppdlr_ad0a7e33d9a03f4986937032c25ee7435}{statistic\+\_\+t}}}]{statistic }\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ab471fd1439bcd11be6bc10de9703138a}\label{namespacecppdlr_ab471fd1439bcd11be6bc10de9703138a} 
...
Discretization of analytic continuation kernel on given grid   
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ad4b931a8f12802eee8e74307c655ca85}\label{namespacecppdlr_ad4b931a8f12802eee8e74307c655ca85} 
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
...
Discretization of analytic continuation kernel on given grid   
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a38c50dbbe81c1821676393f8584fb3f6}\label{namespacecppdlr_a38c50dbbe81c1821676393f8584fb3f6} 
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
...
Discretization of analytic continuation kernel on given grid 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a45377bb09b54d66487cf379b1a6037de}\label{namespacecppdlr_a45377bb09b54d66487cf379b1a6037de} 
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
...
Get imaginary time discretization of analytic continuation kernel with L\texorpdfstring{$^\wedge$}{\string^}2 weighting.   
...
Discretization of analytic continuation kernel on given grid   
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ad6df2a0cc73644667ba77bf562a9e140}\label{namespacecppdlr_ad6df2a0cc73644667ba77bf562a9e140} 
\index{cppdlr@{cppdlr}!build\_k\_it@{build\_k\_it}}
\index{build\_k\_it@{build\_k\_it}!cppdlr@{cppdlr}}
...
Discretization of analytic continuation kernel on given grid 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a72bd9e9181d379daa28fb3d96bc5ebca}\label{namespacecppdlr_a72bd9e9181d379daa28fb3d96bc5ebca} 
...
{\footnotesize\ttfamily nda\+::vector$<$ double $>$ cppdlr\+::build\+\_\+rf\+\_\+fine (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&}]{fine,  }\item[{bool}]{symmetrize = {\ttfamily false} }\end{DoxyParamCaption})}
...
\mbox{\texttt{ in}}  & {\em fine} & Fine grid parameters \\
\hline
\mbox{\texttt{ in}}  & {\em symmetrize} & If true, include omega=0, making the grid odd-\/sized and mirror-\/symmetric about it.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Fine real frequency grid 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a2d46bf12944fe36c90343df67e2d783b}\label{namespacecppdlr_a2d46bf12944fe36c90343df67e2d783b} 
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a721215e26c8f2e4de53d07f34c517823}\label{namespacecppdlr_a721215e26c8f2e4de53d07f34c517823} 
\index{cppdlr@{cppdlr}!flip\_to\_mirror@{flip\_to\_mirror}}
\index{flip\_to\_mirror@{flip\_to\_mirror}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{flip\_to\_mirror()}{flip\_to\_mirror()}}
{\footnotesize\ttfamily template$<$typename V $>$ \\
bool cppdlr\+::flip\+\_\+to\+\_\+mirror (\begin{DoxyParamCaption}\item[{V const \&}]{piv,  }\item[{long}]{mirror\+\_\+max }\end{DoxyParamCaption})}



Decide whether a selected DLR node set should be flipped to its mirror image. 

Node selection is degenerate under the kernel\textquotesingle{}s mirror symmetry (index p \texorpdfstring{$<$}{<}-\/\texorpdfstring{$>$}{>} mirror\+\_\+max -\/ p), so the pivoted Gram-\/\+Schmidt may pick either orientation depending on BLAS backend or compiler. For reproducibility, always keep the orientation whose ascending index sequence compares smaller element-\/by-\/element (flipping to the mirror when it is the smaller of the two).


\begin{DoxyParams}{Parameters}
{\em piv} & Selected indices, sorted in ascending order. \\
\hline
{\em mirror\+\_\+max} & Index p is mirrored to mirror\+\_\+max -\/ p. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true iff the mirror set is lexicographically smaller (the caller should flip). 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a4b753b1a7de53aff215a230206908e6d}\label{namespacecppdlr_a4b753b1a7de53aff215a230206908e6d} 
\index{cppdlr@{cppdlr}!free\_gf@{free\_gf}}
\index{free\_gf@{free\_gf}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{free\_gf()}{free\_gf()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
auto cppdlr\+::free\+\_\+gf (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{\mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&}]{itops,  }\item[{Ht const \&}]{h,  }\item[{bool}]{time\+\_\+order }\end{DoxyParamCaption})}
...
\hline
\mbox{\texttt{ in}}  & {\em it} & \doxylink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops} object \\
\hline
\mbox{\texttt{ in}}  & {\em h} & Hamiltonian \\
\hline
\mbox{\texttt{ in}}  & {\em time\+\_\+order} & Flag for ordinary (false or ORDINARY) or time-\/ordered (true or TIME\+\_\+\+ORDERED) Dyson equation, which changes free Green\textquotesingle{}s function\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a02424caf43ace0c3330b2fa03f706400}\label{namespacecppdlr_a02424caf43ace0c3330b2fa03f706400} 
\index{cppdlr@{cppdlr}!free\_gf@{free\_gf}}
\index{free\_gf@{free\_gf}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{free\_gf()}{free\_gf()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename Ht $>$ \newline
requires (std\+::floating\+\_\+point$<$Ht$>$ \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} nda\+::\+Memory\+Matrix$<$Ht$>$)\\
auto cppdlr\+::free\+\_\+gf (\begin{DoxyParamCaption}\item[{double}]{beta,  }\item[{\mbox{\hyperlink{classcppdlr_1_1imtime__ops}{imtime\+\_\+ops}} const \&}]{itops,  }\item[{Ht const \&}]{h,  }\item[{double}]{mu = {\ttfamily 0},  }\item[{bool}]{time\+\_\+order = {\ttfamily false} }\end{DoxyParamCaption})}
...
Hamiltonian must either be a symmetric matrix, a Hermitian matrix, or a real scalar. 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_afbfcb627a6ab1115bb02670e7ce61219}\label{namespacecppdlr_afbfcb627a6ab1115bb02670e7ce61219} 
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a9b0726a01d8e6a062f8abc1fc9fa1320}\label{namespacecppdlr_a9b0726a01d8e6a062f8abc1fc9fa1320} 
...
{\footnotesize\ttfamily std\+::tuple$<$ double, double $>$ cppdlr\+::geterr\+\_\+k\+\_\+it (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classcppdlr_1_1fineparams}{fineparams}} const \&}]{fine,  }\item[{nda\+::vector\+\_\+const\+\_\+view$<$ double $>$}]{t,  }\item[{nda\+::vector\+\_\+const\+\_\+view$<$ double $>$}]{om,  }\item[{nda\+::matrix\+\_\+const\+\_\+view$<$ double $>$}]{kmat }\end{DoxyParamCaption})}
...
\end{DoxyNote}
\Hypertarget{namespacecppdlr_af8f77e12b089b5ddb5b5b3cda18cf623}\label{namespacecppdlr_af8f77e12b089b5ddb5b5b3cda18cf623} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the analytic continuation kernel using dimensionless variables is K(i nu\+\_\+n, om) = 1 / (i nu\+\_\+n -\/ om) with i nu\+\_\+n = (2n+1) \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi (fermionic case) or i nu\+\_\+n = 2n \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi (bosonic case). 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a672098c598c55c8f9da60cd194a741ea}\label{namespacecppdlr_a672098c598c55c8f9da60cd194a741ea} 
\index{cppdlr@{cppdlr}!k\_if@{k\_if}}
\index{k\_if@{k\_if}!cppdlr@{cppdlr}}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the analytic continuation kernel at a given inverse temperature beta is K(i nu\+\_\+n, om) = 1 / (i nu\+\_\+n -\/ om) with i nu\+\_\+n = (2n+1) \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi / beta (fermionic case) or i nu\+\_\+n = 2n \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi / beta (bosonic case). 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_ab73f52d9e0209e584d1210d419f39f8c}\label{namespacecppdlr_ab73f52d9e0209e584d1210d419f39f8c} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the bosonic analytic continuation kernel using dimensionless variables is K(i nu\+\_\+n, om) = 1 / (i nu\+\_\+n -\/ om) with i nu\+\_\+n = 2n \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi. 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a66270b210c46b39737f361467f645be7}\label{namespacecppdlr_a66270b210c46b39737f361467f645be7} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the fermionic analytic continuation kernel using dimensionless variables is K(i nu\+\_\+n, om) = 1 / (i nu\+\_\+n -\/ om) with i nu\+\_\+n = (2n+1) \texorpdfstring{$\ast$}{*} i \texorpdfstring{$\ast$}{*} pi. 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_afc9726e02898098dfff8448f02f5b3c6}\label{namespacecppdlr_afc9726e02898098dfff8448f02f5b3c6} 
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the analytic continuation kernel using dimensionless variables is K(t,om) = -\/exp(-\/t \texorpdfstring{$\ast$}{*} om)/(1 + exp(-\/om)). 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a3cfc4afda9cacac00e93425fe9d45a93}\label{namespacecppdlr_a3cfc4afda9cacac00e93425fe9d45a93} 
\index{cppdlr@{cppdlr}!k\_it@{k\_it}}
\index{k\_it@{k\_it}!cppdlr@{cppdlr}}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
The definition of the analytic continuation kernel at a given inverse temperature beta is K(t,om) = -\/exp(-\/t\texorpdfstring{$\ast$}{*}om)/(1+exp(-\/beta \texorpdfstring{$\ast$}{*} om)). 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a7dfaf907221eb1768418258421af703f}\label{namespacecppdlr_a7dfaf907221eb1768418258421af703f} 
...
The definition of the analytic continuation kernel using dimensionless variables is K(t,om) = -\/exp(-\/t \texorpdfstring{$\ast$}{*} om)/(1 + exp(-\/om)). 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_adcede29d3876b4a265f09a56db33085d}\label{namespacecppdlr_adcede29d3876b4a265f09a56db33085d} 
...
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a767cf14e0aef568fefdb0386d255b510}\label{namespacecppdlr_a767cf14e0aef568fefdb0386d255b510} 
\index{cppdlr@{cppdlr}!normsq@{normsq}}
\index{normsq@{normsq}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{normsq()}{normsq()}}
{\footnotesize\ttfamily double cppdlr\+::normsq (\begin{DoxyParamCaption}\item[{nda\+::\+Memory\+Vector auto const \&}]{v }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
x The squared norm of the vector 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_a1d0c839b446002a589c9cc22534967b6}\label{namespacecppdlr_a1d0c839b446002a589c9cc22534967b6} 
\index{cppdlr@{cppdlr}!pivrgs@{pivrgs}}
\index{pivrgs@{pivrgs}!cppdlr@{cppdlr}}
\doxysubsubsection{\texorpdfstring{pivrgs()}{pivrgs()}}
{\footnotesize\ttfamily template$<$nda\+::\+Memory\+Array\+Of\+Rank$<$ 2 $>$ T, nda\+::\+Scalar S = nda\+::get\+\_\+value\+\_\+t$<$\+T$>$$>$ \\
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Tuple of (1) matrix whose rows form orthogonal basis of row space of {\ttfamily a} to {\ttfamily eps} tolerance, (2) vector with entry k given by the squared l2 norm of the orthogonal complement of kth selected row with respect to subspace spanned by first k-\/1 selected rows, (3) vector of pivots 
\end{DoxyReturn}
\Hypertarget{namespacecppdlr_ae2becc5e7e7dfe9a59d7a45c309a2e47}\label{namespacecppdlr_ae2becc5e7e7dfe9a59d7a45c309a2e47} 
...
This is a translation of the Fortran subroutine "{}qrdgrm"{} by V. Rokhlin, with symmetrization added.
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Tuple of (1) matrix whose rows are leading {\ttfamily r} vectors in orthogonal basis of row space of {\ttfamily a}, (2) vector with entry k given by the squared l2 norm of the orthogonal complement of kth selected row with respect to subspace spanned by first k-\/1 selected rows, (3) vector of pivots
\end{DoxyReturn}
\begin{DoxyNote}{Note}
...
{\ttfamily r} may be as large as n+1, where n is the column dimension of A -- one more than the largest meaningful rank. Mirror-\/paired rows are selected two at a time, so if A has no self-\/symmetric row (m even) the number of selected rows is even, and spanning a row space of odd dimension n requires selecting n+1 rows. The last of these is linearly dependent on the others, so its basis vector and its entry of the returned norms vector are meaningless; only the pivots should be used. The symmetrized fermionic Matsubara grid is constructed this way; see \doxylink{classcppdlr_1_1imfreq__ops}{imfreq\+\_\+ops}. 
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a373b198ea4a2d60eb80052dc0d4ae229}\label{namespacecppdlr_a373b198ea4a2d60eb80052dc0d4ae229} 
...
Converting a point from relative to absolute time format will, in general, result in a loss of relative accuracy in the location of the point if the point is close to t = 1. For example, in three-\/digit arithmetic, the point t = 0.\+999111 could be stored in relative format as t\texorpdfstring{$^\wedge$}{\string^}\texorpdfstring{$\ast$}{*} = -\/0.\+889e-\/3, but only as t = 0.\+999 in absolute format. For more information on the relative time format used in cppdlr, please see the Background section of the cppdlr documentation.   
\end{DoxyNote}
\Hypertarget{namespacecppdlr_a3b1ccba6393dfc517757677a13ad2553}\label{namespacecppdlr_a3b1ccba6393dfc517757677a13ad2553} 
\index{cppdlr@{cppdlr}!rel2abs@{rel2abs}}
\index{rel2abs@{rel2abs}!cppdlr@{cppdlr}}
